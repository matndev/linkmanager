function tableInit() {
    ...
    Array.prototype.forEach.call(
        document.querySelectorAll("table.lm-table th"),
        function (th, index, array) {
            ...
            grip.style.backgroundImage = 'linear-gradient(90deg, rgba(54,54,54,1) 30%, rgba(64,64,64,1) 30%, rgba(95,95,95,1) 70%, rgba(54,54,54,1) 70%)';
